...
// //             </div>
// //             <div>
// //               <p className="font-bold text-slate-900 text-sm leading-none">CodeScaler</p>
// //               <p className="text-xs text-slate-500">Internship Admission 2026</p>
// //             </div>
// //           </div>
...
// const CLASSES = ["BCA", "MCA", "B.Tech", "BA", "BSC"];
// const SEMESTERS = ["2nd", "4th", "6th", "8th"];
// const COURSES = ["Frontend Web Design", "Full Stack Development", "Data Analysis"];
// const GENDERS = ["Male", "Female", "Other"];
